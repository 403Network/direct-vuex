 ...
 */
export function createModule<O extends WithOptionalState, S = StateOf<O>>(
  options: O & ModuleOptions<S>
): O;
...
export type StateOf<O> = O extends { state: StateDeclaration }
  ? O["state"]
  : {};
...
export interface ModulesImpl<S = any> {
  [moduleName: string]: ModuleOptions<S>;
}
...
export type GetterImpl<S = any, G = any> = (
  state: S,
  getters: G,
  rootState: any,
  rootGetters: any
